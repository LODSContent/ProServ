...
azd auth login --client-id $clientId --client-secret $clientSecret --tenant-id $tenantId 2>&1 |
...
azd init -t azure/gpt-rag -b workshop -e dev-lab 2>&1 |
    Tee-Object -FilePath $azdLogFile -Append |
    Tee-Object -FilePath $logFile -Append
...
azd env set AZURE_SUBSCRIPTION_ID $subscriptionId | Tee-Object -FilePath $azdLogFile -Append
azd env set AZURE_LOCATION eastus2 | Tee-Object -FilePath $azdLogFile -Append
azd env set AZURE_NETWORK_ISOLATION false | Tee-Object -FilePath $azdLogFile -Append
az account set --subscription $subscriptionId | Out-Null

# === [10] Provision Infrastructure ===
Write-Log "Provisioning infrastructure..."
azd provision --environment dev-lab 2>&1 |
    Tee-Object -FilePath $azdLogFile -Append |
    Tee-Object -FilePath $logFile -Append
