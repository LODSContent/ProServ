# gpt-rag.ps1 (Updated: Pre-provision OpenAI, handle soft-deleted conflicts, and confirm OpenAI readiness)
...
# 10.1) Retry fallback OpenAI provisioning if not provisioned
